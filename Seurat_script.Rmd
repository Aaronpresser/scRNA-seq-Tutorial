...
# trouble running a particular line of code, make sure the syntax of a particular line aligns EXACTLY with the syntax used either in this tutorial here, or 
# on the reference page (you can find how to use very Seurat function here: https://satijalab.org/seurat/reference/)
...
# will often find an answer on Biostars, some random message board, or ...
...
# before they will be will be answered elsewhere. Look up "[my institution] research computing" or "[my institution] hpcc office" or "[my institution] it office" etc.
```
